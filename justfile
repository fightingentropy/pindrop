...
release version:
	...
	echo "     https://github.com/fightingentropy/pindrop/actions"
	echo ""
	echo "  2. Once complete, review the published release:"
	echo "     https://github.com/fightingentropy/pindrop/releases"
	echo ""
